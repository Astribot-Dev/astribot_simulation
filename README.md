...
- Error related to `GLIBCXX_3.4.30 not found` or `cv_bridge` when installing dependencies
**Solution:**  
...
- Error related to `libffi.so.7` or `cv_bridge` when launching the simulation
**Solution:**  
Run the patch script to fix:
```bash
