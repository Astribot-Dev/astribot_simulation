...
from lib.constants import (WHITE_SHELL, BLACK_ACCENT, DARK_THRESHOLD,
                           LOGO_Y_CENTER, LOGO_Z_CENTER, ZONE_HALF,
                           FRONT_THRESHOLD)
...
def main():
    ...
    if white_mask.any():
        ...
        flat_groups.append({
            ...
            'diffuse': WHITE_SHELL,
            'positions': sv, 'normals': sn, 'faces': sf,
        })
    ...
    tex_group = {
        ...
        'positions': sv, 'normals': sn, 'faces': sf, 'uvs': uvs,
    }
