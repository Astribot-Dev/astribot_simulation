...
def convert_glb_to_dae(glb_path, dae_path):
    ...
    def add_group(meshes, material_id, material_name, diffuse):
        ...
        for m in meshes:
            ...
            norms = m.vertex_normals if hasattr(m, 'vertex_normals') and m.vertex_normals is not None else np.zeros_like(m.vertices)
    ...
    print(f"  Output: {total_verts} verts, {total_faces} faces, "
