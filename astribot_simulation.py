...
def main():
    ...
    # astribot_yaml_file=f'config/astribot_s1/simulation_isaaclab_param.yaml'
    # astribot_yaml_file=f'config/astribot_s1/simulation_maniskill_param_chassis_fixed.yaml'
    # astribot_yaml_file=f'config/astribot_s1/simulation_genesis_param_chassis_fixed.yaml'
