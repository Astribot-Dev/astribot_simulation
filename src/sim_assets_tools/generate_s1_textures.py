...
def process_mesh(stl_path, mesh_name, color_func, tex_size=TEX_SIZE, bg_color=COLOR_WHITE_SHELL):
    ...
    tex, mask = rasterize_face_colors(new_faces, uvs, face_colors, tex_size, bg_color)
