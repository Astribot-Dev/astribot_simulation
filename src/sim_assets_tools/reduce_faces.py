...
def main():
    ...
    parser.add_argument("--ratio", type=float, default=0.2, help="Target face ratio (default: 0.2)")
    parser.add_argument(
        "--scale", type=float, default=None, help="Vertex scale factor (e.g. 0.001 for mm->m)"
    )
